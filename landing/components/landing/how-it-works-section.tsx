...
const steps = [
  {
    number: "01",
    title: "Register",
    subtitle: "your cluster",
    description: "Upload your kubeconfig configuration securely and configure metrics server endpoints using the /setup command in your Discord server.",
    code: ``,
  },
  {
    number: "02",
    title: "Monitor",
    subtitle: "24/7 loops",
    description: "Our system runs a continuous loop watching pod health, resources, and error rates, alerting your designated Discord channel when failures occur.",
    code: ``,
  },
  {
    number: "03",
    title: "Diagnose",
    subtitle: "with AI reasoning",
    description: "Run /diagnose on any service to invoke stateful multi-agent LangGraph analysis across logs and Prometheus metrics to retrieve CLI fixes.",
    code: ``,
  },
];
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-white/30">Monitor.</span>
              <span className="block text-white/10">Diagnose.</span>
            </h2>
          </div>
