...
const plans = [
  {
    ...
    features: [
      ...
      "Core product features + basic AI",
      "Landing page + simple frontend",
  ...
  },
  {
    ...
    description: "For rapid scaling and market expansion",
    price: { monthly: 65000, annual: 65000 },
    features: [
      "10-week custom development",
      "Advanced AI features + polished UX",
  ...
  },
  {
    ...
    description: "For mission-critical products",
    price: { monthly: null, annual: null },
    features: [
      "12-16 week custom engagement",
